export default {
  ...
  'modal.contact.message.sent.success': 'Vaše zpráva byla úspěšně odeslána.',
  'modal.contact.message.thank.you': "Díky, že jste mi napsali",
  'cta.button.processing': "Odesílám",
  'sending.error': 'Něco se pokazilo. Zkuste to prosím ještě jednou pouzději',
  ...
  'contact.metaDescription': 'Michaela Houf - kontakt. Máte pro mě zprávu nebo otázku? Napište mi!',
  'contact.metaTitle': 'Michaela Houf - Kontakt',
}