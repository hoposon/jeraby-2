...
<script setup lang="ts">
  ...
  const nextPrevWorks = computed(() => {
    ...
    console.log('🚀 ~ file: WorkDetail.vue:81 ~ nextPrevWorks ~ currentCollection.value?[prev]:', [currentCollection.value[prev], currentCollection.value[currentId.value], currentCollection.value[next]])
