<template>
  ...
  >
    ...
    <label 
      :for="id"
      class="absolute top-[14px] left-0 pl-2 transition-all duration-300 ease-in-out text-sm peer-focus:top-1 peer-focus:text-[10px] peer-[.filled]:top-1 peer-[.filled]:text-[10px] pointer-events-none"
    >
      {{ translate(label) }}
    </label>
    <div
